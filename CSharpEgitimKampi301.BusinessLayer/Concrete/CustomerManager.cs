...
/*
 Data access katmanının aynısını yazıyoruz. 
 Ama farklı olarak burada validasyon şartları yazıyoruz:
if(entity.CustomerName!="" && entity.CustomerName.Length>=3 && entity.CustomerCity!=null && entity.CustomerSurname!="" && entity.CustomerName.Length <= 30)
            {
                _customerDal.Insert(entity);
            }
...
Bu validasyon şartlarını sadece birinde değil diğer yerlerde de yazarız.
*/
